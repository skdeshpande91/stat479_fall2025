...
execute: 
  ...
  freeze: auto
---
## Motivation: Beth Mead's performance at EURO2022 {#sec-motivation}

During the EURO2022 football tournament, English player Beth Mead scored 6 goals.
Here are links to videos for three of her goals:

  * Goal against Austria [link](https://youtu.be/lVGiGZN2gdw?t=1)
  * Goal against Norway [link](https://youtu.be/lVGiGZN2gdw?t=148)
  * Goal against Sweden [link](https://youtu.be/lVGiGZN2gdw?t=148)

Which is most impressive to you?
<!--
::: {#fig-mead-shots layout-ncol=3 fig-align="center"}
![Mead shot against Austria [link]](figures/mead_austria.png)
...
## Working with soccer event data {#sec-statsbomb-data}
...
## More sophisticated XG models {#sec-sophisticate-xg}
...
So, according to StatsBomb's proprietary model, if Mead repeatedly attempted the three shots introduced in @sec-motivatino, we should expect them to result in goals 36%, 44%, and 9% of the time.
