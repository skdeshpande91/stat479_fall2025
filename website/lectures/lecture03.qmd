...
@fig-tree-approx illustrates this: the true function is shown in pink and various tree approximations are shown in green.

![As the number of leaves increases (i.e., tree becomes deeper), we obtain more accurate approximations](figures/tree_appx_wide.png)
...
![Complex trees can be represented as sums of simpler trees](figures/sum_of_trees.png)
