...
Recall from [Lecture 2](lecture2.qmd) that a key assumption of XG models is the observed dataset comprises a *sample* from some infinite super-population of shots.
