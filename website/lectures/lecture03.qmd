...
In [Lecture 2](lectures02.qmd), we fit two very basic models for XG.
...
## Comparing XG models {#sec-model-comparison}
...
## The training/testing paradigm {#sec-train-test}
...
### Account for multiple predictors {#sec-addtl-preds}
...
$$
\beta_{0} + \beta_{1}\times \textrm{DistToGoal} + \beta_{LeftFoot}\times \mathbb{I}(\textrm{LeftFoot}) + \beta_{RightFoot} \times \mathbb{I}(\textrm{RightFoot})
$$
...
### Comparison to StatsBomb's model {#sec-comparison}
