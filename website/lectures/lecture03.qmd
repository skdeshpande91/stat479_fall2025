...
### Regression Trees & Ensembles #{sec-tree-background}


<!--
  Fact: just about every function of $p$ inputs can be approximated arbitrarily well
  using a piecewise constant step-function
  Sums-of-trees
  
  RF is one way to do this; technical details are beyond the scope of this course 
