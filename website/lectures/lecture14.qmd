...
![Graphical representation of the transition probabilities in a two-state Markov chain with one absorbing state](figures/two-state-graph.png){#fig-twostate-graph width=50% fig-align="center"}
...
![Graphical representation of the transition probabilities in a three-state Markov chain with one absorbing state](figures/three-state-graph.png){#fig-threestate-graph width=50% fig-align="center"}
