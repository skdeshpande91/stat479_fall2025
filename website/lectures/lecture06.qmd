...
### Accessing StatCast Data{#sec-statcast-query}
...
We will use the development version of **baseballr**, which can be installed using the code
```{r}
...
![Dodgers-Padres Play-by-Play](figures/lecture3_dodgers_pbp.png){fig-align="center"}
