...
<!--
  Baserunners should get epsilon while batters should get delta - epsilon
-->
...
Since we're not ultimately intersted in the parameters $\alpha_{\textrm{g}}$ and $\alpha_{\textrm{e}},$ we will not, at this time, check whether this is a reasonable assumption nor will we rely on any of these inferential results.
:::
