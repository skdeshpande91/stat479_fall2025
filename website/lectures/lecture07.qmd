...
### Dealing with Missing Events {#sec-missing-events}
...
But, if the sentnce contains the word "score", it sets the number of bases advanced to 3, since the runner scored from first.
```{r}
...
Interestingly, the player with the largest $\textrm{RAA}^{\textrm{br}}$, Jose Ramirez, is known for his aggressive baserunning[^ramirez].
