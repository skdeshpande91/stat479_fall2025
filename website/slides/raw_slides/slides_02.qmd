...
![StatsBomb Coordinates](statsbomb_coordinates.png){fig-asp=0.75, width="60%"}
...
:::{.fragment}
```{r}
#| label: euro2022-columns
#| eval: true
#| echo: false
my_cols <- 
  c("match.id", "player.name", "OpposingTeam", "minute","location.x", "location.y",
    "shot.type.name", 
...
colnames(euro2022_shots)[colnames(euro2022_shots) %in% my_cols]
```
:::
...
![](piazza_teammate_qr.png){width="30%" fig-align="center"}
