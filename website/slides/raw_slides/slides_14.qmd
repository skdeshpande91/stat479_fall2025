...
- Interested in several probabilities & random quantities
  ...
  - First $n$ such that $X_{t} \in A$: e.g., # at-bats needed to get at least one out
...
## $n$-step Transitions I 

- Suppose $X_{t} = s$. What is $\mathbb{P}(X_{t+2} = s' \vert X_{t} = s)$? 
  - If we start at-bat in `1.000`, chances of being at `2.100` in exactly 2 at-bats?
